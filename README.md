...
_Updated on 2026-08-17 UTC. Recent arXiv papers are filtered by track; implementation anchors keep the radar useful when a topic is quiet or rate-limited._

| Track | Recent papers | Implementation anchors |
| --- | --- | --- |
| Post-training / alignment | [MINT: A Universal Zero-Shot Predictor for Transaction Data](http://arxiv.org/abs/2608.14198v1) (2026-08-14)<br>[QUASAR: Lowering the Loss Floor of Quantization-Aware Training with Loss-Aware Reconstruction](http://arxiv.org/abs/2608.13966v1) (2026-08-14) | [TRL docs](https://huggingface.co/docs/trl)<br>[PEFT docs](https://huggingface.co/docs/peft)<br>[LLaMA Factory](https://github.com/hiyouga/LLaMA-Factory) |
| Reasoning / evaluation | [Information Satisfaction: A Reader-Centered Axis for Summarization Evaluation](http://arxiv.org/abs/2608.14457v1) (2026-08-14)<br>[Whose doctor does the AI recommend? An algorithm audit of reputation and demographic signals in large language model-assisted physician choice](http://arxiv.org/abs/2608.14399v1) (2026-08-14) | [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness)<br>[Inspect](https://inspect.aisi.org.uk/)<br>[OpenAI Evals](https://github.com/openai/evals) |
| Agents / tool use | [HERMES: a multi-agent framework for structured knowledge extraction from ultra-long documents in geoscience](http://arxiv.org/abs/2608.14055v1) (2026-08-14)<br>[Never the Number: Structural Abstention for AI Systems Whose Answers Are Consumed as Fact](http://arxiv.org/abs/2608.13926v1) (2026-08-14) | [MCP docs](https://modelcontextprotocol.io/docs/getting-started/intro)<br>[LangGraph docs](https://docs.langchain.com/oss/python/langgraph/overview)<br>[AutoGen docs](https://microsoft.github.io/autogen/) |
| RAG / memory | [LLMs Don't Pay for the Jump](http://arxiv.org/abs/2608.14397v1) (2026-08-14)<br>[AnchorBench: A Multi-Pathway Benchmark for the Anchoring Effect in LLMs](http://arxiv.org/abs/2608.14320v1) (2026-08-14) | [LlamaIndex docs](https://docs.llamaindex.ai/)<br>[Haystack evaluation](https://docs.haystack.deepset.ai/docs/evaluation)<br>[Ragas docs](https://docs.ragas.io/)<br>[GraphRAG](https://www.microsoft.com/en-us/research/project/graphrag/) |
| Inference / serving | [Finding Vulnerabilities via LLM-Augmented Semantics-Aware Type-Checking](http://arxiv.org/abs/2608.14533v1) (2026-08-14)<br>[Knowing When to Stop: Bayesian Optimal Stopping for LLM Evaluations](http://arxiv.org/abs/2608.14425v1) (2026-08-14) | [vLLM docs](https://docs.vllm.ai/)<br>[SGLang docs](https://docs.sglang.io/)<br>[TensorRT-LLM docs](https://nvidia.github.io/TensorRT-LLM/)<br>[llama.cpp](https://github.com/ggml-org/llama.cpp) |
| Multimodal / documents | [A Survey of Large Models in Sports](http://arxiv.org/abs/2608.14377v1) (2026-08-14)<br>[Seeing Red, Thinking Bad: Color Bias in Vision Language Models](http://arxiv.org/abs/2608.14286v1) (2026-08-14) | [lmms-eval](https://github.com/EvolvingLMMs-Lab/lmms-eval)<br>[VLMEvalKit](https://github.com/open-compass/VLMEvalKit)<br>[LlamaIndex document parsing](https://docs.cloud.llamaindex.ai/) |
| Data / distillation | [A Survey of Large Models in Sports](http://arxiv.org/abs/2608.14377v1) (2026-08-14)<br>[Local and Global Regimes of Geometric Complexity in Language Model Representations](http://arxiv.org/abs/2608.14361v1) (2026-08-14) | [Hugging Face Datasets](https://huggingface.co/docs/datasets)<br>[Argilla docs](https://docs.argilla.io/)<br>[Datatrove](https://github.com/huggingface/datatrove) |
<!-- FRONTIER-RADAR:END -->
