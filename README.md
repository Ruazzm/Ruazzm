...
_Updated on 2026-06-29 UTC. Recent arXiv papers are filtered by track; implementation anchors keep the radar useful when a topic is quiet or rate-limited._

| Track | Recent papers | Implementation anchors |
| --- | --- | --- |
| Post-training / alignment | [HPRO: Hierarchical Progressive Reward Optimization via Preference Extraction for Emotional Text-to-Speech](http://arxiv.org/abs/2606.28249v1) (2026-06-26)<br>[From Black-Box to Clinical Insight: A Multi-Stage Explainable Framework for Speech-Based Cognitive Impairment Detection](http://arxiv.org/abs/2606.27973v1) (2026-06-26) | [TRL docs](https://huggingface.co/docs/trl)<br>[PEFT docs](https://huggingface.co/docs/peft)<br>[LLaMA Factory](https://github.com/hiyouga/LLaMA-Factory) |
| Reasoning / evaluation | [Cognitive Episodes in LLM Reasoning Traces Enable Interpretable Human Item Difficulty Prediction](http://arxiv.org/abs/2606.28186v1) (2026-06-26)<br>[Single and Multi Truth Data Fusion using Large Language Models](http://arxiv.org/abs/2606.28062v1) (2026-06-26) | [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness)<br>[Inspect](https://inspect.aisi.org.uk/)<br>[OpenAI Evals](https://github.com/openai/evals) |
| Agents / tool use | [Dialogue to Detection: A Multimodal Hybrid NLP Pipeline for Insurance Fraud Detection](http://arxiv.org/abs/2606.28002v1) (2026-06-26)<br>[From Black-Box to Clinical Insight: A Multi-Stage Explainable Framework for Speech-Based Cognitive Impairment Detection](http://arxiv.org/abs/2606.27973v1) (2026-06-26) | [MCP docs](https://modelcontextprotocol.io/docs/getting-started/intro)<br>[LangGraph docs](https://docs.langchain.com/oss/python/langgraph/overview)<br>[AutoGen docs](https://microsoft.github.io/autogen/) |
| RAG / memory | [Vision-Default, Prior-Override: Causal Mechanisms of Perception-Knowledge Conflict in Vision-Language Models](http://arxiv.org/abs/2606.28273v1) (2026-06-26)<br>[Cognitive Episodes in LLM Reasoning Traces Enable Interpretable Human Item Difficulty Prediction](http://arxiv.org/abs/2606.28186v1) (2026-06-26) | [LlamaIndex docs](https://docs.llamaindex.ai/)<br>[Haystack evaluation](https://docs.haystack.deepset.ai/docs/evaluation)<br>[Ragas docs](https://docs.ragas.io/)<br>[GraphRAG](https://www.microsoft.com/en-us/research/project/graphrag/) |
| Inference / serving | [Push Puppet Networks: Structured Bayesian Pruning Algorithm for Language Model Compression](http://arxiv.org/abs/2606.28251v1) (2026-06-26)<br>[JD Oxygen AI Item Center (Oxygen AIIC) V1: An Industrial-Scale LLM/VLM-Centric Solution for Item Understanding, Management, and Applications](http://arxiv.org/abs/2606.28070v1) (2026-06-26) | [vLLM docs](https://docs.vllm.ai/)<br>[SGLang docs](https://docs.sglang.io/)<br>[TensorRT-LLM docs](https://nvidia.github.io/TensorRT-LLM/)<br>[llama.cpp](https://github.com/ggml-org/llama.cpp) |
| Multimodal / documents | [Vision-Default, Prior-Override: Causal Mechanisms of Perception-Knowledge Conflict in Vision-Language Models](http://arxiv.org/abs/2606.28273v1) (2026-06-26)<br>[Dialogue to Detection: A Multimodal Hybrid NLP Pipeline for Insurance Fraud Detection](http://arxiv.org/abs/2606.28002v1) (2026-06-26) | [lmms-eval](https://github.com/EvolvingLMMs-Lab/lmms-eval)<br>[VLMEvalKit](https://github.com/open-compass/VLMEvalKit)<br>[LlamaIndex document parsing](https://docs.cloud.llamaindex.ai/) |
| Data / distillation | [Cognitive Episodes in LLM Reasoning Traces Enable Interpretable Human Item Difficulty Prediction](http://arxiv.org/abs/2606.28186v1) (2026-06-26)<br>[Single and Multi Truth Data Fusion using Large Language Models](http://arxiv.org/abs/2606.28062v1) (2026-06-26) | [Hugging Face Datasets](https://huggingface.co/docs/datasets)<br>[Argilla docs](https://docs.argilla.io/)<br>[Datatrove](https://github.com/huggingface/datatrove) |
<!-- FRONTIER-RADAR:END -->
