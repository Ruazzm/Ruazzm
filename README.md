...
_Updated on 2026-08-03 UTC. Recent arXiv papers are filtered by track; implementation anchors keep the radar useful when a topic is quiet or rate-limited._

| Track | Recent papers | Implementation anchors |
| --- | --- | --- |
| Post-training / alignment | [Learning Latent Reasoning Traces for Scalar Reward Models End-to-End](http://arxiv.org/abs/2607.29185v1) (2026-07-31)<br>[FairFund-Bench: Evaluating Distributive Bias in LLM Resource Allocation](http://arxiv.org/abs/2607.28934v1) (2026-07-31) | [TRL docs](https://huggingface.co/docs/trl)<br>[PEFT docs](https://huggingface.co/docs/peft)<br>[LLaMA Factory](https://github.com/hiyouga/LLaMA-Factory) |
| Reasoning / evaluation | [TokTier: Exact Stateful Tokenization for Agentic LLM Serving](http://arxiv.org/abs/2607.29678v1) (2026-07-31)<br>[FriendBench: Benchmarking Dyadic Familiarity Inference in Humans and Multimodal Large Language Models](http://arxiv.org/abs/2607.29602v1) (2026-07-31) | [lm-evaluation-harness](https://github.com/EleutherAI/lm-evaluation-harness)<br>[Inspect](https://inspect.aisi.org.uk/)<br>[OpenAI Evals](https://github.com/openai/evals) |
| Agents / tool use | [TokTier: Exact Stateful Tokenization for Agentic LLM Serving](http://arxiv.org/abs/2607.29678v1) (2026-07-31)<br>[Know It, Act on It: Investigating Memory Utilization in LLM Personalization](http://arxiv.org/abs/2607.29433v1) (2026-07-31) | [MCP docs](https://modelcontextprotocol.io/docs/getting-started/intro)<br>[LangGraph docs](https://docs.langchain.com/oss/python/langgraph/overview)<br>[AutoGen docs](https://microsoft.github.io/autogen/) |
| RAG / memory | [ResKV: Reconstructing Omitted Attention Contributions for Fixed-Budget KV Cache Compression](http://arxiv.org/abs/2607.29591v1) (2026-07-31)<br>[Sycophancy Undermines Epistemic Vigilance in Cooperative Vision-Language Tasks](http://arxiv.org/abs/2607.29585v1) (2026-07-31) | [LlamaIndex docs](https://docs.llamaindex.ai/)<br>[Haystack evaluation](https://docs.haystack.deepset.ai/docs/evaluation)<br>[Ragas docs](https://docs.ragas.io/)<br>[GraphRAG](https://www.microsoft.com/en-us/research/project/graphrag/) |
| Inference / serving | [TokTier: Exact Stateful Tokenization for Agentic LLM Serving](http://arxiv.org/abs/2607.29678v1) (2026-07-31)<br>[CodeShrink: Adaptive Visual Compression for Efficient Multimodal Code Understanding](http://arxiv.org/abs/2607.29637v1) (2026-07-31) | [vLLM docs](https://docs.vllm.ai/)<br>[SGLang docs](https://docs.sglang.io/)<br>[TensorRT-LLM docs](https://nvidia.github.io/TensorRT-LLM/)<br>[llama.cpp](https://github.com/ggml-org/llama.cpp) |
| Multimodal / documents | [WCM: A World Critic Model for Vision-Language-Action Reinforcement Learning](http://arxiv.org/abs/2607.29613v1) (2026-07-31)<br>[FriendBench: Benchmarking Dyadic Familiarity Inference in Humans and Multimodal Large Language Models](http://arxiv.org/abs/2607.29602v1) (2026-07-31) | [lmms-eval](https://github.com/EvolvingLMMs-Lab/lmms-eval)<br>[VLMEvalKit](https://github.com/open-compass/VLMEvalKit)<br>[LlamaIndex document parsing](https://docs.cloud.llamaindex.ai/) |
| Data / distillation | [ARB: A Matched Authorship-Rewriting Benchmark Dataset for AI-Text Detector Evaluation](http://arxiv.org/abs/2607.29539v1) (2026-07-31)<br>[PTP: Previous-Token Prediction based LLM Inversion for Near-Exact Prompt Reconstruction](http://arxiv.org/abs/2607.29378v1) (2026-07-31) | [Hugging Face Datasets](https://huggingface.co/docs/datasets)<br>[Argilla docs](https://docs.argilla.io/)<br>[Datatrove](https://github.com/huggingface/datatrove) |
<!-- FRONTIER-RADAR:END -->
